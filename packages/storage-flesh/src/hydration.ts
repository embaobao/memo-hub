...
export class Hydrator {
  ...
  async hydrateRecord(record: VectorRecord & { text?: string }, options: HydrationOptions = {}): Promise<VectorRecord & { text?: string }> {
    ...
    try {
      ...
      return { ...record, text: hydratedText } as VectorRecord & { text?: string };
    } catch {
  ...
  async hydrateRecords(records: (VectorRecord & { text?: string })[], options: HydrationOptions = {}): Promise<(VectorRecord & { text?: string })[]> {
