# ai-provider-plugin Specification

## Purpose
The ai-provider-plugin capability defines the interface and implementation for AI services, including text embedding and chat completion, supporting multiple backends like Ollama.
