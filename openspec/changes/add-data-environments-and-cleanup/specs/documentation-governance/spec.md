...
- **WHEN** a user runs examples, tests, or adapter scans experimentally
- **THEN** the docs show environment-variable based storage/log path overrides or future env profile commands
